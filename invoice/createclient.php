...
<body class="font-sans text-gray-700">
    ...
    <div class="ml-[16.666%] p-3 h-screen">
        ...
        <main class="bg-white">
                <div class="p-3">
                    <h1 class="text-2xl font-bold mb-4">取引先の新規登録</h1>
                    <form action="clients_create.php" method="POST">
                        <!-- 取引先情報 -->
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="font-semibold">取引先名 <span class="text-orange-500">*</span></label>
                                <input type="text" name="client_name" class="border border-gray-300 rounded-md w-full p-2 my-2" required>
                            </div>
                            <div>
                                <label class="font-semibold">管理コード</label>
                                <input type="text" name="management_code" class="border border-gray-300 rounded-md w-full p-2 my-2">
                            </div>
                            <div>
                                <label class="font-semibold">部署・担当者</label>
                                <input type="text" name="department_person" class="border border-gray-300 rounded-md w-full p-2 my-2">
                            </div>
                            <div>
                                <label class="font-semibold">メールアドレス</label>
                                <input type="email" name="email" class="border border-gray-300 rounded-md w-full p-2 my-2">
                            </div>
                            <div>
                                <label class="font-semibold">メールアドレス（CC）</label>
                                <input type="email" name="email_cc" class="border border-gray-300 rounded-md w-full p-2 my-2">
                            </div>
                            <div>
                                <label class="font-semibold">郵便番号</label>
                                <input type="text" name="postal_code" placeholder="123-4567" class="border border-gray-300 rounded-md w-full p-2 my-2">
                            </div>
                            <div>
                                <label class="font-semibold">住所（都道府県・市区町村）</label>
                                <input type="text" name="address_city" class="border border-gray-300 rounded-md w-full p-2 my-2">
                            </div>
                            <div>
                                <label class="font-semibold">住所（番地・ビル名）</label>
                                <input type="text" name="address_building" class="border border-gray-300 rounded-md w-full p-2 my-2">
                            </div>
                            <div>
                                <label class="font-semibold">郵送先の宛名</label>
                                <input type="text" name="recipient_name" class="border border-gray-300 rounded-md w-full p-2 my-2">
                            </div>
                            <div>
                                <label class="font-semibold">敬称</label>
                                <input type="text" name="name_honorific" placeholder="御中" class="border border-gray-300 rounded-md w-full p-2 my-2">
                            </div>
                            <div>
                                <label class="font-semibold">電話番号</label>
                                <input type="tel" name="phone" class="border border-gray-300 rounded-md w-full p-2 my-2">
                            </div>
                            <div>
                                <label class="font-semibold">FAX番号</label>
                                <input type="tel" name="fax" class="border border-gray-300 rounded-md w-full p-2 my-2">
                            </div>
                        </div>
                        <!-- メモ -->
                        <div class="mt-4">
